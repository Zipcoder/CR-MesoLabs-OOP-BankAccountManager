...
public class TransactionServicesTest {
    ...
    public void getTransactionByUserTest() {
        ...
        ArrayList<Transaction> expected = new ArrayList<Transaction>(Arrays.asList(trans2,trans4,trans5));
        ArrayList<Transaction> actual = transactionsServices.getTransactionsForUser(user2);
    ...
    public void getTransactionForAccountTest() {
        ...
        ArrayList<Transaction> expected = new ArrayList<Transaction>(Arrays.asList(trans2,trans5));
        ArrayList<Transaction> actual = transactionsServices.getTransactionsForAccount(account2);
